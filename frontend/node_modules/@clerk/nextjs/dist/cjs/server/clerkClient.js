...
const clerkClient = async () => {
  ...
  const options = (_b = (_a = import_clerkMiddleware.clerkMiddlewareRequestDataStorage.getStore()) == null ? void 0 : _a.get("requestData")) != null ? _b : requestData;
